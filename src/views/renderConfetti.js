...
const renderConfetti = () => {
  ...
  let confettiDiv;
  if (document.getElementById("confetti")) return; // returns immediately if we already have a confetti container on screen
  ...
  for (let i = 1; i <= count; i++) {
    const confetti = createEle('div', '', confettiDiv) // creates a random number of confetti divs (up to 8)
